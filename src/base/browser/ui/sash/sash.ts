...
import './sash.css'
import { IDisposable, dispose, Disposable, DisposableStore } from 'base/common/lifecycle';
...
import { getElementsByTagName, EventHelper, createStyleSheet, addDisposableListener, append, $ } from 'base/browser/dom';
